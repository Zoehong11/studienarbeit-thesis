...
\subsectionnotoc{Solving Wordle with Informatiion Theory}
% wordle
...
% connections
Information theory can be applied to Connections as well. Detailed description see next chapter.
